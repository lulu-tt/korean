...
const KO = {
  ...
  // 황해남도
  'Anak':'안악군','Chongdan':'청단군','Haeju City':'해주군','Jangyon':'장연군','Kangryong':'강령군',
...
const PROV_MEMBERS = {
  ...
  '평안남도': ['Anju City','Kaechon City','Mundok','Maengsan','Taedong','Jungsan','Pyongsong City',
    ...
    'Tokchon City','Tukjang','Yangdok','Taehung','Hoechang'],
  '평안북도': ['Changsong','Cholsan','Chonma','Jongju City','Kujang','Kusong City','Kwaksan',
    ...
    'Sonchon','Taegwan','Thaechon','Tongchang','Tongrim','Uiju','Unjon','Yomju'],
  ...
  '황해북도': ['Hwangju','Junghwa','Koksan','Kumchon','Phyongsan','Pongsan','Rinsan',
...
//  주의: 랑림군은 통일부가 두음 미적용(낭림 아님)이라 변환 안 함.
const SOUTH_NAME = {
  '룡천군':'용천군','녕변군':'영변군','녕원군':'영원군',
  '라선시':'나선시','린산군':'인산군','리원군':'이원군','룡강군':'용강군','룡림군':'용림군',
  '룡연군':'용연군','은률군':'은율군','경원군':'새별군','경흥군':'은덕군'
};
// 병기(전통명 대표 + 개명명 괄호): 김일성 일가 개명 등 — NKMap 방식
const BYEONGGI = {
  '김책시':['성진시','김책시'], '김형직군':['후창군','김형직군'], '김정숙군':['신파군','김정숙군'],
  '김형권군':['풍산군','김형권군'], '영광군':['오로군','영광군'], '락원군':['퇴조군','낙원군']
};
